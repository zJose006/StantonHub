...
export function Footer({ navigate }) {
  const footerLinks = [[routes.home,'Inicio'],[routes.ships,'Naves'],[routes.shipCompare,'Comparador'],[routes.components,'Componentes'],[routes.miningMaterials,'Materiales'],[routes.gameNews,'Noticias'],[routes.profile,'Perfil']];
  return (
