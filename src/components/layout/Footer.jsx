...
export function Footer({ navigate }) {
  const footerLinks = [[routes.home,'Inicio'],[routes.forum,'Operaciones'],[routes.guides,'Guias'],[routes.gameNews,'Actualidad'],[routes.ships,'Naves'],[routes.components,'Componentes'],[routes.news,'Intel'],[routes.profile,'Perfil']];
  return (
